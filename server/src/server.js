...
const q=`UPDATE clientes SET codigo=$1,nome=$2,razao_social=$3,nome_fantasia=$4,nome_completo=$5,cpf_cnpj=$6,nascimento=$7,tipo_cliente=$8,email=$9,telefone=$10,whatsapp=$11,cep=$12,endereco=$13,numero=$14,complemento=$15,bairro=$16,cidade=$17,estado=$18,origem_cadastro=$19,responsavel=$20,status=$21,categoria_cac=$22,cr_numero=$23,cr_emissao=$24,cr_validade=$25,cr_situacao=$26,cr_orgao=$27,observacoes=$28,updated_at=NOW() WHERE id=$29 RETURNING *`;
