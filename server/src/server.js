...
const v=[b.codigo||null,b.nome||b.nome_completo||b.razao_social,b.razao_social||null,b.nome_fantasia||null,b.nome_completo||null,b.cpf_cnpj||null,b.nascimento||null,b.naturalidade||null,b.filiacao_pai||null,b.filiacao_mae||null,b.estado_civil||null,b.rg||null,b.rg_orgao||null,b.tipo_cliente||null,b.email||null,b.telefone||null,b.whatsapp||null,b.cep||null,b.endereco||null,b.numero||null,b.complemento||null,b.bairro||null,b.cidade||null,b.estado||null,b.origem_cadastro||null,b.responsavel||null,b.status||'ativo',b.categoria_cac||null,b.cr_numero||null,b.cr_emissao||null,b.cr_validade||null,b.cr_situacao||null,b.cr_orgao||null,b.observacoes||null,id];
const r=await pool.query(q,v);if(!r.rowCount)return res.status(404).json({error:'Cliente não encontrado'});await pool.query('INSERT INTO audit_logs(user_id,acao,entidade,entidade_id,detalhes) VALUES($1,$2,$3,$4,$5)',[req.user.id,'editar','cliente',id,{nome:r.rows[0].nome}]);res.json(r.rows[0]);
